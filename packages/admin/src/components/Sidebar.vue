...
<template>
  <SidebarProvider>
    <Sidebar>
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent v-if="dropdownOpen" class="w-(--radix-dropdown-menu-trigger-width)" align="start">
                <DropdownMenuItem v-for="version in data.versions" :key="version" @click="setSelectedVersion(version)">
                  v{{ version }}
      ...
      <SidebarContent>
        <SidebarGroup v-for="item in theme.sidebar" :key="item.title">
